...
public class TestReadAddress {
	...
	public void testAddEmployee() throws Exception {
		...
		when(addressService.findById(1l)).thenReturn(Optional.of(addressResponse));

		Gson GSON = new Gson();

		mockMvc.perform(MockMvcRequestBuilders.get("/petz/v1/address/1")
